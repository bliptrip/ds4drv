...
create_mapping(
    "ds4-fake", "Fake Sony Computer Entertainment Wireless Controller",
    # Bus type,     vendor, product, version
    ecodes.BUS_USB, 1356,   1476,    273,
    # Axes
    {
        "ABS_RZ":       "left_analog_x",
        "ABS_Z":        "left_analog_y",
    ...
    # Axes options
    {
        "ABS_RZ": (128, 0, 255, 0, 5),
        "ABS_Z": (128, 0, 255, 0, 5),
        "ABS_RX": (128, 0, 255, 0, 5),
        "ABS_RY": (128, 0, 255, 0, 5),
        "ABS_X": (0, 0, 255, 0, 5),
        "ABS_Y": (0, 0, 255, 0, 5),
    },
    # Buttons
